...
class CommandLineInterface(object):
    ...
    def train(self):
        ...
        self.parser_predict.add_argument("-mtestA", help="MetCCS Agilent test datasets to create the model",
                                         default=None)
        self.parser_predict.add_argument("-mtestW", help="MetCCS Waters test datasets to create the model",
                                         default=None)
        ...
        self.parser_predict.add_argument("-nd",
                                         help="New Data to create the model, list of template file (file1.csv,file2.csv,...)",
                                         default=None)
